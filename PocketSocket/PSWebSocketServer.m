...
- (void)connect:(BOOL)silent {
  ...
  if (_isSystemAssignedPort) {
    ...
    if (getsockname(CFSocketGetNative(_socket), (struct sockaddr *)&sin, &addrlen) == 0) {
...
- (void)clearSocket {
    NSLog(@"%s isSocketExist = %i", __FUNCTION__, _socket != nil);
    if (_socket) {
...
- (void)notifyDelegateDidStart {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate serverDidStart:sself];
            }
      });
}
...
- (void)notifyDelegateFailedToStart:(NSError *)error {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate server:sself didFailWithError:error];
            }
      });
}
...
- (void)notifyDelegateDidStop {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate serverDidStop:sself];
            }
      });
}
...
- (void)notifyDelegateWebSocketDidOpen:(PSWebSocket *)webSocket {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate server:sself webSocketDidOpen:webSocket];
            }
      });
}
...
- (void)notifyDelegateWebSocket:(PSWebSocket *)webSocket
    ...
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate server:sself webSocket:webSocket didReceiveMessage:message];
            }
      });
}
...
- (void)notifyDelegateWebSocket:(PSWebSocket *)webSocket
    ...
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
            if (sself) {
                [sself.delegate server:sself webSocket:webSocket didFailWithError:error];
            }
      });
}
...
- (void)notifyDelegateWebSocketDidFlushInput:(PSWebSocket *)webSocket {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
          if (sself && [sself.delegate respondsToSelector:@selector(server:webSocketDidFlushInput:)]) {
              [sself.delegate server:sself webSocketDidFlushInput:webSocket];
          }
      });
}
...
- (void)notifyDelegateWebSocketDidFlushOutput:(PSWebSocket *)webSocket {
    __weak typeof(self) wself = self;
      dispatch_async((_delegateQueue) ? _delegateQueue : dispatch_get_main_queue(), ^{
          __strong typeof(self) sself = wself;
          if (sself && [sself.delegate respondsToSelector:@selector(server:webSocketDidFlushOutput:)]) {
              [sself.delegate server:sself webSocketDidFlushOutput:webSocket];
          }
      });
}
...
- (BOOL)askDelegateShouldAcceptConnection:
  ...
  [self executeDelegateAndWait:^{
    __strong typeof(self) sself = wself;
    if (sself && [sself.delegate respondsToSelector:@selector(server:
      ...
      accept = [sself.delegate server:sself
...
- (void)dealloc {
    NSLog(@"PSWebSocketServer dealloc isMainThread = %i, self = %p", [NSThread isMainThread], self);
    [self disconnect:YES];
}
